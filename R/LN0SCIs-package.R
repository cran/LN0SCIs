...
#' the method based on generalized pivotal quantity with order statistics (\code{\link{GPQH}} and \code{\link{GPQW}}),
#' and the method based on two-step MOVER intervals (\code{\link{FMW}} and \code{\link{FMWH}}).
#'
#'
#' @name LN0SCIs
#' @aliases LN0SCIs
